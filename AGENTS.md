...
- Latest test status: **169 backend tests passing**, Ruff clean, Ruff format clean. Verified locally with `.uv-test-venv\Scripts\python.exe`. UI production build passes via `npm run build` in mock mode.
