...
### Next priorities
1. Build the first ClusteringAgent prototype over the embeddings. This requires approval before creating the new `gold.comment_clusters` Delta schema/table.
