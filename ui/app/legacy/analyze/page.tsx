        ...
        <section className="mx-auto max-w-6xl px-6 py-12 md:py-16">
          <div className="border-b border-rule pb-8 mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground max-w-[76ch] leading-relaxed">
                ...
                For broad topic monitoring, use the <a href="/legacy/watchlist" className="text-brand hover:underline font-semibold">Watchlist</a> or 
                the <a href="/legacy/discoveries" className="text-brand hover:underline font-semibold">Discovered Rulemakings</a> panel.
              </p>
            </div>
          ...
          <section className="mt-10 bg-card border border-rule rounded-sm p-6">
            ...
            <p className="mt-4 text-[11px] text-muted-foreground leading-relaxed">
              ...
              <code className="font-mono mx-1">/legacy/analyze?agency=SEC</code>
